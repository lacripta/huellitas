...
function ParametrosEspeciesCtrl($scope, $uibModal, $http, DTOptionsBuilder, DTColumnBuilder, SweetAlert) {
    var vm = this;
    ...
    function borrarSeleccionado() {
        if ($scope.selected = $scope.dtEditarArtiulo.DataTable.row('.selected').data()) {
            SweetAlert.swal({
                ...
                if (isConfirm) {
                    $http.post('/easyapp/refugio/parametros/especies/borrar', {json: JSON.stringify($scope.selected)}).success(function (data) {
...
function EspeciesModalController($scope, $uibModalInstance, $http, SweetAlert) {
    $scope.ok = function () {
        $http.post('/easyapp/refugio/parametros/especies/agregar', {json: JSON.stringify($scope.selected)}).success(function (data) {
...
angular
        .module('easyapp')
        .controller('ParametrosEspeciesCtrl', ParametrosEspeciesCtrl);