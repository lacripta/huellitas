...
function EstadoAdopcionController($scope, $uibModal, $http, DTOptionsBuilder, DTColumnBuilder, SweetAlert) {
    var vm = this;
    ...
    function borrarSeleccionado() {
        if ($scope.selected = $scope.dtEditarArtiulo.DataTable.row('.selected').data()) {
            SweetAlert.swal({
                ...
                if (isConfirm) {
                    $http.post('/easyapp/refugio/parametros/adopciones/estados/borrar', {json: JSON.stringify($scope.selected)}).success(function (data) {
...
function EstadoAdopcionModalController($scope, $uibModalInstance, $http, SweetAlert) {
    $scope.ok = function () {
        $http.post('/easyapp/refugio/parametros/adopciones/estados/agregar', {json: JSON.stringify($scope.selected)}).success(function (data) {
